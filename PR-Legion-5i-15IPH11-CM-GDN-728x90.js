...
lib.ssMetadata = [
		{name:"PR_Legion_5i_15IPH11_CM_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_5i_15IPH11_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion5i15IPH11CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(360).to({_off:false},0).to({y:10.45},12).wait(38));
...
// library properties:
lib.properties = {
	id: 'CE374C4B7393DE4F8C4917A140F400FD',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_5i_15IPH11_CM_GDN_728x90_atlas_1.png", id:"PR_Legion_5i_15IPH11_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['CE374C4B7393DE4F8C4917A140F400FD'] = {
